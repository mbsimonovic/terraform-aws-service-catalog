...
output "config_s3_bucket_names" {
  ...
  value       = module.app_baseline.config_s3_bucket_names
}
...
output "cloudtrail_kms_key_alias_name" {
  ...
  value       = module.app_baseline.cloudtrail_kms_key_alias_name
}

output "cloudtrail_cloudwatch_group_name" {
  description = "The name of the cloudwatch log group."
  value       = module.app_baseline.cloudtrail_cloudwatch_group_name
}
...
output "kms_key_arns" {
  ...
  value       = module.app_baseline.kms_key_arns
}
...
output "kms_key_aliases" {
  ...
  value       = module.app_baseline.kms_key_aliases
}
