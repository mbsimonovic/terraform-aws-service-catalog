...
output "primary_bucket_arn" {
  ...
  value       = module.s3_bucket.primary_bucket_arn
}

output "primary_bucket_domain_name" {
  description = "The bucket domain name. Will be of format bucketname.s3.amazonaws.com."
  value       = module.s3_bucket.primary_bucket_domain_name
}

output "primary_bucket_regional_domain_name" {
  description = "The bucket region-specific domain name. The bucket domain name including the region name, please refer here for format. Note: The AWS CloudFront allows specifying S3 region-specific endpoint when creating S3 origin, it will prevent redirect issues from CloudFront to S3 Origin URL."
  value       = module.s3_bucket.primary_bucket_regional_domain_name
}
...
output "access_logging_bucket_name" {
  description = "The name of the access_logging S3 bucket."
  value       = module.s3_bucket.access_logging_bucket_name
}
