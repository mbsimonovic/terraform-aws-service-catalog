...
This is an example of how to use the [RDS module](/modules/data-stores/rds) to deploy an Amazon RDS Database instance. This example is optimized for learning, experimenting, and testing (but not direct production usage).
