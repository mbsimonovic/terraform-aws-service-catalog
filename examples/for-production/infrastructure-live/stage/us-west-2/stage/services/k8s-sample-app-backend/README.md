# Gruntwork Sample App backend EKS Service
...
See [the module docs](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.34.1/modules/services/k8s-service) for more
