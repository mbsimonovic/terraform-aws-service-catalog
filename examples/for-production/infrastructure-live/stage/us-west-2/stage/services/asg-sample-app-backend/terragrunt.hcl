...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/asg-service?ref=v0.44.2"
...
inputs = {
  ...
  secrets_access = [
    "arn:aws:secretsmanager:us-west-2:456789012345:secret:RDSDBConfig-abcd1234",
    "arn:aws:secretsmanager:us-west-2:456789012345:secret:TLSBackEndSecretsManagerArn-abcd1234",
  ]
  ...
  cloud_init_parts = {
    "gruntwork-sample-app" = {
      ...
      content = templatefile("sample-app-user-data.sh", {
        ...
        db_config_secrets_manager_arn       = "arn:aws:secretsmanager:us-west-2:456789012345:secret:RDSDBConfig-abcd1234"
        tls_config_secrets_manager_arn      = "arn:aws:secretsmanager:us-west-2:456789012345:secret:TLSBackEndSecretsManagerArn-abcd1234"
        secrets_manager_config = yamlencode({
          "secretsManager" : {
            "region" : local.aws_region,
            "dbId" : "arn:aws:secretsmanager:us-west-2:456789012345:secret:RDSDBConfig-abcd1234",
            "tlsId" : "arn:aws:secretsmanager:us-west-2:456789012345:secret:TLSBackEndSecretsManagerArn-abcd1234",
          }
        })
