...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/data-stores/aurora?ref=v0.44.2"
...
inputs = {
  ...
  db_config_secrets_manager_id = "arn:aws:secretsmanager:us-west-2:567890123456:secret:RDSDBConfig-abcd1234"
