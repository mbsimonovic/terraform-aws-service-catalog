...
inputs = {
  ...
  secrets_access = [
    ...
    "arn:aws:secretsmanager:us-west-2:567890123456:secret:TLSFrontEndSecretsManagerArn-abcd1234",
  ]
  ...
  cloud_init_parts = {
    "gruntwork-sample-app" = {
      ...
      content = templatefile("sample-app-user-data.sh", {
        ...
        tls_config_secrets_manager_arn = "arn:aws:secretsmanager:us-west-2:567890123456:secret:TLSFrontEndSecretsManagerArn-abcd1234"
        secrets_manager_config = yamlencode({
          "secretsManager" : {
            "region" : local.aws_region,
            "tlsId" : "arn:aws:secretsmanager:us-west-2:567890123456:secret:TLSFrontEndSecretsManagerArn-abcd1234",
          }
        })
