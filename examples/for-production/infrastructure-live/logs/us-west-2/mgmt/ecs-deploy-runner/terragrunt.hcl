...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/mgmt/ecs-deploy-runner?ref=v0.62.0"
  ...
  ec2_worker_pool_configuration = {
    ami_filters = {
      ...
      filters = [
        {
          name   = "name"
          values = ["ecs-deploy-runner-worker-v0.62.0-*"]
        },
      ]
    }
