...
# This is the common component configuration for networking/alb-internal. The common variables for each environment to
# deploy networking/alb-internal are defined here. This configuration will be merged into the environment configuration
...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/networking/alb?ref=v0.65.0"
