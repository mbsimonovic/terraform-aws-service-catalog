...
# This is the common component configuration for services/eks-core-services. The common variables for each environment to
# deploy services/eks-core-services are defined here. This configuration will be merged into the environment configuration
...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/eks-core-services?ref=v0.65.0"
...
# ---------------------------------------------------------------------------------------------------------------------
locals {
  source_base_url = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/eks-core-services"
...
inputs = {
  ...
  # Cluster autoscaler needs more resources than the default
