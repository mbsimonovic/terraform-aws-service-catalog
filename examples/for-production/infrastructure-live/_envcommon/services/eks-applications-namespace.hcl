...
# This is the common component configuration for services/eks-applications-namespace. The common variables for each environment to
# deploy services/eks-applications-namespace are defined here. This configuration will be merged into the environment configuration
...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/k8s-namespace?ref=v0.70.0"
  source = "${get_parent_terragrunt_dir()}/../../../../..//modules/services/k8s-namespace"
}
...
# ---------------------------------------------------------------------------------------------------------------------
locals {
  source_base_url = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/k8s-namespace"
