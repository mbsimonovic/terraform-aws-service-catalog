...
# This is the common component configuration for services/ecs-sample-app-frontend. The common variables for each environment to
# deploy services/ecs-sample-app-frontend are defined here. This configuration will be merged into the environment configuration
...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/ecs-service?ref=v0.82.0"
