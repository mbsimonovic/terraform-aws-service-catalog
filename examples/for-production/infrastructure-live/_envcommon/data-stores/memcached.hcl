...
# This is the common component configuration for data-stores/memcached. The common variables for each environment to
# deploy data-stores/memcached are defined here. This configuration will be merged into the environment configuration
...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/data-stores/memcached?ref=v0.70.0"
  source = "${get_parent_terragrunt_dir()}/../../../../..//modules/data-stores/memcached"
}
...
# ---------------------------------------------------------------------------------------------------------------------
locals {
  source_base_url = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/data-stores/memcached"
...
# ---------------------------------------------------------------------------------------------------------------------
inputs = {
  name            = "memcached-${local.name_prefix}-${local.account_name}"
