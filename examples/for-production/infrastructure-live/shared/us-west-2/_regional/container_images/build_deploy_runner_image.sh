...
# https://github.com/gruntwork-io/terraform-aws-ci/blob/v0.41.1/modules/ecs-deploy-runner/docker/deploy-runner

set -e

readonly DOCKERFILE_REPO="https://github.com/gruntwork-io/terraform-aws-ci.git"
readonly DOCKERFILE_REPO_REF="v0.41.1"
...
function run {
  ...
  infrastructure-deployer --aws-region "$DEPLOY_RUNNER_REGION" -- docker-image-builder build-docker-image \
    ...
    --build-arg 'terragrunt_version=v0.35.20' \
    --build-arg 'kubergrunt_version=v0.8.0'
}
