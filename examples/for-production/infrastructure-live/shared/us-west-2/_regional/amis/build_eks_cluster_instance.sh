...
# https://github.com/gruntwork-io/terraform-aws-service-catalog/blob/v0.62.0/modules/services/eks-workers/eks-node-al2.pkr.hcl
#
# Pass in the --run-local flag to build the image on the local machine, without going through the ECS Deploy Runner.

set -e

readonly PACKER_TEMPLATE_REPO="https://github.com/gruntwork-io/terraform-aws-service-catalog.git//modules/services/eks-workers/eks-node-al2.pkr.hcl"
