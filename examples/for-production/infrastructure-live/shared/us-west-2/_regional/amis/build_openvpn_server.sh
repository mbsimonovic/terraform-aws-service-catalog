...
# https://github.com/gruntwork-io/terraform-aws-service-catalog/blob/v0.38.1/modules/mgmt/openvpn-server/openvpn-server.json
...
ami_account_ids="$stage_account_id,$prod_account_id,$dev_account_id"
