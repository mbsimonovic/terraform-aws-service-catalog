...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/data-stores/aurora?ref=v0.36.1"
...
# ---------------------------------------------------------------------------------------------------------------------
inputs = {
  name              = "aurora-${local.name_prefix}-${local.account_name}"
  instance_type     = "db.t3.medium"
  vpc_id            = dependency.vpc.outputs.vpc_id
  aurora_subnet_ids = dependency.vpc.outputs.private_persistence_subnet_ids

  db_config_secrets_manager_id = "arn:aws:secretsmanager:us-west-2:345678901234:secret:RDSDBConfig-abcd1234"
