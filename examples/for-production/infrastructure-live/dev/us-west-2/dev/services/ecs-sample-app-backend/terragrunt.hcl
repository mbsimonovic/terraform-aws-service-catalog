...
terraform {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/ecs-service?ref=v0.54.0"
...
locals {
  ...
  tls_secrets_manager_arn = "arn:aws:secretsmanager:us-west-2:345678901234:secret:TLSBackEndSecretsManagerArn-abcd1234"
  db_secrets_manager_arn  = "arn:aws:secretsmanager:us-west-2:345678901234:secret:RDSDBConfig-abcd1234"
