...
module "customer_master_keys" {
  source = "git::git@github.com:gruntwork-io/module-security.git//modules/kms-master-key-multi-region?ref=v0.36.8"
...
module "kms_grants" {
  source            = "git::git@github.com:gruntwork-io/module-security.git//modules/kms-grant-multi-region?ref=v0.36.8"
  aws_account_id    = var.aws_account_id
  seed_region       = var.aws_region
  opt_in_regions    = var.kms_cmk_opt_in_regions
