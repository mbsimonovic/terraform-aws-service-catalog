...
module "cloudtrail_cmk" {
  source               = "git::git@github.com:gruntwork-io/module-security.git//modules/kms-master-key?ref=v0.34.1"
...
module "customer_master_keys" {
  source         = "git::git@github.com:gruntwork-io/module-security.git//modules/kms-master-key-multi-region?ref=v0.34.1"
  aws_account_id = var.aws_account_id
  seed_region    = var.aws_region
...
module "vpc" {
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-mgmt?ref=v0.9.1"
