...
module "organization" {
  source = "git::git@github.com:gruntwork-io/module-security.git//modules/aws-organizations?ref=v0.36.6"
...
module "organizations_config_rules" {
  source = "git::git@github.com:gruntwork-io/module-security.git//modules/aws-config-rules?ref=v0.36.6"
