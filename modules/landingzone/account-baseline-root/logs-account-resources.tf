...
module "config_bucket" {
  source = "git::git@github.com:gruntwork-io/module-security.git//modules/aws-config-bucket?ref=v0.41.2"
...
module "cloudtrail_bucket" {
  source = "git::git@github.com:gruntwork-io/module-security.git//modules/cloudtrail-bucket?ref=v0.41.2"
