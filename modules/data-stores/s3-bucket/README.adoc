...
* https://github.com/gruntwork-io/module-security/tree/master/modules/private-s3-bucket[Gruntwork private-s3-bucket module]: The underlying module that implements the private S3 bucket functionality.
