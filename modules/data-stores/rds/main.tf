...
module "database" {
  source = "git::git@github.com:gruntwork-io/module-data-storage.git//modules/rds?ref=v0.17.1"
...
module "rds_alarms" {
  source           = "git::git@github.com:gruntwork-io/terraform-aws-monitoring.git//modules/alarms/rds-alarms?ref=v0.24.0"
...
module "metric_widget_rds_cpu_usage" {
  source = "git::git@github.com:gruntwork-io/terraform-aws-monitoring.git//modules/metrics/cloudwatch-dashboard-metric-widget?ref=v0.24.0"
...
module "create_snapshot" {
  source           = "git::git@github.com:gruntwork-io/module-data-storage.git//modules/lambda-create-snapshot?ref=v0.17.1"
...
module "share_snapshot" {
  source           = "git::git@github.com:gruntwork-io/module-data-storage.git//modules/lambda-share-snapshot?ref=v0.17.1"
  create_resources = var.share_snapshot_with_another_account
...
module "cleanup_snapshots" {
  source           = "git::git@github.com:gruntwork-io/module-data-storage.git//modules/lambda-cleanup-snapshots?ref=v0.17.1"
  create_resources = var.share_snapshot_with_another_account
...
module "backup_job_alarm" {
  source           = "git::git@github.com:gruntwork-io/terraform-aws-monitoring.git//modules/alarms/scheduled-job-alarm?ref=v0.24.0"
...
module "kms_cmk" {
  source = "git::git@github.com:gruntwork-io/module-security.git//modules/kms-master-key?ref=v0.44.6"
