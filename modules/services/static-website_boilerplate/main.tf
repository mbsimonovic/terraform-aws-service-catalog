# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# CREATE A STATIC WEBSITE IN AN S3 BUCKET{{ if .IncludeCloudFront }} AND DEPLOY CLOUDFRONT AS A CDN IN FRONT OF IT{{ end }}
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
module "static_website" {
  source = "git::git@github.com:gruntwork-io/package-static-assets.git//modules/s3-static-website?ref={{ .PackageStaticAssetsVersion }}"

  website_domain_name = var.website_domain_name
  index_document      = var.index_document
  error_document      = var.error_document

  {{- if not .IncludeCloudFront }}

  create_route53_entry = var.create_route53_entry
  hosted_zone_id       = data.terraform_remote_state.route53_public.*.outputs.primary_domain_hosted_zone_id[0]
  {{- end }}
...
module "cloudfront" {
  source = "git::git@github.com:gruntwork-io/package-static-assets.git//modules/s3-cloudfront?ref={{ .PackageStaticAssetsVersion }}"
