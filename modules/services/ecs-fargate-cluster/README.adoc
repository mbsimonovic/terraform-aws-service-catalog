...
This folder contains https://www.terraform.io[Terraform] code to deploy a production-grade ECS cluster for Fargate usage
only on https://aws.amazon.com[AWS] using
...
cluster on top of an Auto Scaling Group, refer to the link:../ecs-cluster[ecs-cluster module]. Refer to the section
