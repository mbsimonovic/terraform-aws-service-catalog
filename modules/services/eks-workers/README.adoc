...
link:core-concepts.md#how-do-i-perform-a-blue-green-release-to-roll-out-new-versions-of-the-module[How do I perform a
blue green release to roll out new versions of the module] section of the documentation.
