...
module "static_website" {
  ...
  source = "git::git@github.com:gruntwork-io/package-static-assets.git//modules/s3-static-website?ref=edabb4c"
...
module "cloudfront" {
  ...
  source = "git::git@github.com:gruntwork-io/package-static-assets.git//modules/s3-cloudfront?ref=edabb4c"
