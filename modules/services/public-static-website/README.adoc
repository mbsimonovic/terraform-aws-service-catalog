...
:description: Deploy a static website from a public S3 bucket using CloudFront CDN.
:icon: /_docs/s3-icon.png
:category: [TODO: fill out]
:cloud: aws
...
This folder contains https://www.terraform.io[Terraform] code to deploy a production-grade public static website on https://aws.amazon.com[AWS] using
https://docs.aws.amazon.com/s3/index.html[S3] and https://docs.aws.amazon.com/cloudfront/index.html[CloudFront].
...
* Deploy a public S3 bucket for your website domain
* Deploy a public S3 bucket for your website domain's logs
* Deploy a public S3 bucket for your CloudFront Distribution's access logs
