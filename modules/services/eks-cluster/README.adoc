...
This folder contains https://www.terraform.io[Terraform] and https://www.packer.io[Packer] code to deploy a production-grade Kubernetes cluster on https://aws.amazon.com[AWS] using
https://docs.aws.amazon.com/eks/latest/userguide/clusters.html[Elastic Kubernetes Service (EKS)].
...
To add and manage additional worker groups, refer to the link:/modules/services/eks-workers[eks-workers module].
