...
This folder contains code to deploy a Kubernetes clusters on https://aws.amazon.com[AWS] using
https://docs.aws.amazon.com/eks/latest/userguide/clusters.html[Elastic Kubernetes Service (EKS)] with
https://www.terraform.io[Terraform] that can be used for either production or non-production workloads.
