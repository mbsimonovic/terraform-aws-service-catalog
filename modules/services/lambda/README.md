...
This folder contains code to deploy a [Lambda](https://aws.amazon.com/lambda) on AWS that can be used for either production or non-production workloads.
...
[terraform-aws-lambda](https://github.com/gruntwork-io/terraform-aws-lambda) repo. If you don’t have access to this repo, email
