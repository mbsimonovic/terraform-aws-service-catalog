...
image:https://img.shields.io/badge/tf-%3E%3D0.13.0-blue.svg[Terraform version]

This folder contains code to deploy a link:https://aws.amazon.com/lambda[Lambda] on AWS that can be used for either production or non-production workloads.

image::../../../_docs/lambda-service-architecture.png?raw=true[Lambda architecture]
...
https://github.com/gruntwork-io/terraform-aws-lambda[terraform-aws-lambda] repo. If you don't have access to this repo, email
...
documentation in the https://github.com/gruntwork-io/terraform-aws-lambda[terraform-aws-lambda] repo.
