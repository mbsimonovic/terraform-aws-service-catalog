:type: service
:name: Route53 Private Hosted Zones
:description: Manage private DNS entries using https://aws.amazon.com/route53/:Amazon Route 53
...
This folder contains code to deploy https://aws.amazon.com/route53/[Route 53 Private Hosted Zones] on AWS.

image::../../../_docs/route53-private-architecture.png?raw=true[Route 53 private architecture]
...
* Manage private DNS entries using AWS Route 53 
