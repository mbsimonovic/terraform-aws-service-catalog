...
module "vpc_network_acls" {
  ...
  create_public_subnet_nacls = var.create_public_subnet_nacls
  create_private_app_subnet_nacls = var.create_private_app_subnet_nacls
  create_private_persistence_subnet_nacls = var.create_private_persistence_subnet_nacls
