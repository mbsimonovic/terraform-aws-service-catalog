...
module "vpc" {
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-app?ref=v0.15.2"
...
module "vpc_peering_connection" {
  source           = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-peering?ref=v0.15.2"
...
module "dns_mgmt_to_app" {
  source           = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-dns-forwarder?ref=v0.15.2"
...
module "vpc_network_acls" {
  ...
  create_public_subnet_nacls = var.create_network_acls && var.create_public_subnet_nacls
  create_private_app_subnet_nacls = var.create_network_acls && var.create_private_app_subnet_nacls
  create_private_persistence_subnet_nacls = var.create_network_acls && var.create_private_persistence_subnet_nacls
