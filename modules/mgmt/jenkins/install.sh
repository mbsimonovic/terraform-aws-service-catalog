...
readonly DEFAULT_MODULE_CI_VERSION="v0.33.1"

# Build tooling
# renovate.json auto-update: kubergrunt
readonly DEFAULT_KUBERGRUNT_VERSION="v0.6.14"
# renovate.json auto-update: terragrunt
readonly DEFAULT_TERRAGRUNT_VERSION="v0.28.19"
...
readonly DEFAULT_TERRAFORM_VERSION="0.13.6"
